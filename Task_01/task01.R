...
trying URL 'http://lib.stat.cmu.edu/R/CRAN/bin/macosx/contrib/4.0/swirl_2.4.5.tgz'
...
The downloaded binary packages are in
	/var/folders/j7/1zsxhnhd0mdf7p8hnjrlkt_40000gn/T//RtmpdCtFKx/downloaded_packages
> library(swirl)
...
What shall I call you? Jae

| Thanks, Jae. Let's cover a couple of quick housekeeping items before we
